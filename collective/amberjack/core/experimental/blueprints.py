...
class Step(object):
    ...
    def __init__(self, tour, name, options):
        ...
        self.microsteps = self.constructMicroSteps(options['microsteps'].splitlines())
        ...
        self.text = normalizeHTML(self._options['text'])

    def constructMicroSteps(self, microsteps):
        results = []
